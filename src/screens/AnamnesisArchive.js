...
import AnamnesisArchiveContainer from '../components/AnamnesisArchiveContainer';

const AnamnesisArchive = () => {
    ...
    return (
        <>
            <View style={styles.container}>
                <BackHeader name={"Anamnesis Archive"} />
                <ScrollView>
                    <AnamnesisArchiveContainer />
                </ScrollView>
...
export default AnamnesisArchive;
