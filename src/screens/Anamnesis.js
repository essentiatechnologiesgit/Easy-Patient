...
import AnamnesisContainer from '../components/AnamnesisContainer';
    ...
    return (
        <>
            <View style={styles.container}>
                <BackHeader name={"Anamnesis"} />
                <TouchableOpacity onPress={() => navigation.navigate("AnamnesisArchive")} style={styles.touch}>
