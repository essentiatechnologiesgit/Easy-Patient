...
const GuidelinesArchiveContainer = () => {
    ...
    return (
        ...
        <TouchableWithoutFeedback onPress={()=>navigation.navigate('GuidelinesView')}>
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.hideContainer} onPress={()=>navigation.navigate("Guidelines")}>
...
export default GuidelinesArchiveContainer;
